        ...
        <div class="container">
            <div class="helpus-text">
                ...
                <div class="d-flex justify-content-center">
                    <a class="btn btn-primary btn-lg helpus-btn " href="https://paypal.me/graperavies?locale.x=en_GB"
                        target="_blank" rel="noopener" aria-label="link to paypal for donations"
